...
@section('title')
    @if ($asset->id)
        @lang('admin/load/form.update') ::
    @else
        @lang('admin/load/form.create') ::
    @endif
@parent
@stop
...
<div class="row form-wrapper">
            ...
            <div class="col-md-12 column">
             ...
             @if ($asset->id)
                 <form class="form-horizontal" method="post" action="{{ route('update/load',$asset->id) }}" autocomplete="off" role="form">
             @else
                 <form class="form-horizontal" method="post" action="{{ route('savenew/load') }}" autocomplete="off" role="form">
             @endif
            ...
            <div class="form-group {{ $errors->has('asset_tag') ? ' has-error' : '' }}">
                <label for="asset_tag" class="col-md-2 control-label">@lang('admin/load/form.tag')
                 *</label>
                 </label>
            ...
            <div class="form-group {{ $errors->has('serial') ? ' has-error' : '' }}">
                <label for="serial" class="col-md-2 control-label">@lang('admin/load/form.serial') </label>
                <div class="col-md-7 col-sm-12">
            ...
            <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                <label for="name" class="col-md-2 control-label">@lang('admin/load/form.name')</label>
                    <div class="col-md-7 col-sm-12">
            ...
            <div class="form-group {{ $errors->has('model_id') ? ' has-error' : '' }}">
                <label for="parent" class="col-md-2 control-label">@lang('admin/load/form.model')
                 *</label>
                 </label>
                <div class="col-md-7 col-sm-12">
            ...
            <div id="mac_address" class="form-group {{ $errors->has('mac_address') ? ' has-error' : '' }}" style="display:none;">
                <label for="mac_address" class="col-md-2 control-label">@lang('admin/load/form.mac_address')</label>
                    <div class="col-md-7 col-sm-12">
            ...
            <div class="form-group {{ $errors->has('purchase_date') ? ' has-error' : '' }}">
                <label for="purchase_date" class="col-md-2 control-label">@lang('admin/load/form.date')</label>
            ...
            <div class="form-group {{ $errors->has('supplier_id') ? ' has-error' : '' }}">
                <label for="supplier_id" class="col-md-2 control-label">@lang('admin/load/form.supplier')</label>
                <div class="col-md-7 col-sm-12">
            ...
            <div class="form-group {{ $errors->has('order_number') ? ' has-error' : '' }}">
                <label for="order_number" class="col-md-2 control-label">@lang('admin/load/form.order')</label>
                <div class="col-md-7 col-sm-12">
            ...
            <div class="form-group {{ $errors->has('purchase_cost') ? ' has-error' : '' }}">
                    <label for="purchase_cost" class="col-md-2 control-label">@lang('admin/load/form.cost') </label>
                    <div class="col-md-2">
            ...
            <div class="form-group {{ $errors->has('warranty_months') ? ' has-error' : '' }}">
                <label for="warranty_months" class="col-md-2 control-label">@lang('admin/load/form.warranty')</label>
                <div class="col-md-2">
                    <div class="input-group">
                    <input class="col-md-2 form-control" type="text" name="warranty_months" id="warranty_months" value="{{{ Input::old('warranty_months', $asset->warranty_months) }}}" />   <span class="input-group-addon">@lang('admin/load/form.months')</span>
            ...
            <div class="form-group {{ $errors->has('status_id') ? ' has-error' : '' }}">
                <label for="status_id" class="col-md-2 control-label">@lang('admin/load/form.status') *</label>
                    <div class="col-md-7 col-sm-12 col-sm-12">
                        ...
                        <p class="help-block">@lang('admin/load/form.help_checkout')</p>
            ...
            <div id="assigned_user" style="display: none;" class="form-group {{ $errors->has('assigned_to') ? ' has-error' : '' }}">
                <label for="parent" class="col-md-2 control-label">@lang('admin/load/form.checkout_to')
                 </label>
                <div class="col-md-7 col-sm-12">
            ...
            <div class="form-group {{ $errors->has('notes') ? ' has-error' : '' }}">
                <label for="notes" class="col-md-2 control-label">@lang('admin/load/form.notes')</label>
                <div class="col-md-7 col-sm-12">
            ...
            <div class="form-group {{ $errors->has('rtd_location_id') ? ' has-error' : '' }}">
                <label for="rtd_location_id" class="col-md-2 control-label">@lang('admin/load/form.default_location')</label>
                    <div class="col-md-7 col-sm-12">
            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  <div class="checkbox">
                    <label>
                      <input type="checkbox" value="1" name="requestable" id="requestable" {{ Input::old('requestable', $asset->requestable) == '1' ? ' checked="checked"' : '' }}> @lang('admin/load/form.requestable')
                    </label>
                  </div>
                </div>
            </div>
