...
<div class="row header">
    <div class="col-md-12">
        <a href="{{ route('create/load') }}" class="btn btn-success pull-right"><i class="fa fa-plus icon-white"></i> @lang('general.create')</a>
        <h3>@lang('general.loads')</h3>
    </div>
</div>
...
<div class="user-profile">
    <div class="row profile">
        <div class="col-md-9 bio">
            {{ Datatable::table()
                ->addColumn(Lang::get('admin/loads/table.title'),
                            Lang::get('admin/loads/general.total'),
                            Lang::get('admin/loads/general.remaining'),
                ...
                ->setOptions(
                        array(
                            ...
                            'sAjaxSource'=>route('api.loads.list'),
                            'dom' =>'T<"clear">lfrtip',
                            'tableTools' => array(
