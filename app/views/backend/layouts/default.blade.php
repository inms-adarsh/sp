...
<html lang="en">
        ...
        <ul class="nav navbar-nav navbar-right">
            @if (Sentry::check())
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                          <li{{ (Request::is('admin/settings/customers*') ? ' class="active"' : '') }}>
                            <a href="{{ URL::to('admin/settings/customers') }}">
                                <i class="fa fa-credit-card"></i> @lang('general.customers')
                            </a>
                        </li>
                        <li{{ (Request::is('hardware/vehicles*') ? ' class="active"' : '') }}>
                            <a href="{{ URL::to('hardware/vehicles') }}">
                                <i class="fa fa-th"></i> @lang('general.vehicles')
                            </a>
                        </li>
                          <li{{ (Request::is('admin/settings/drivers*') ? ' class="active"' : '') }}>
                            <a href="{{ URL::to('admin/settings/drivers') }}">
                                <i class="fa fa-credit-card"></i> @lang('general.drivers')
                            </a>
                        </li>
                         <li{{ (Request::is('admin/settings/items*') ? ' class="active"' : '') }}>
                            <a href="{{ URL::to('admin/settings/items') }}">
                                <i class="fa fa-check"></i> @lang('general.items')
                            </a>
                        </li>
    ...
    <div id="sidebar-nav">
        <ul id="dashboard-menu">
            ...
            <li{{ (Request::is('admin/loads*') ? ' class="active"><div class="pointer"><div class="arrow"></div><div class="arrow_border"></div></div>' : '>') }}
                <a href="{{ URL::to('admin/loads') }}">
                    <i class="fa fa-tint"></i>
                    <span>@lang('general.loads')</span>
                </a>
            </li>
