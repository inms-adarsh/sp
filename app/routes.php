    ...
    */
    Route::group( [ 'prefix' => 'api', 'namespace' => 'Controllers\Admin', 'before' => 'admin-auth' ], function () {
        ...
        Route::group( [ 'prefix' => 'loads' ], function () {
            ...
            Route::get( 'list', [ 'as' => 'api.loads.list', 'uses' => 'LoadsController@getDatatable' ] );
            Route::get( '{accessoryID}/view',
                [ 'as' => 'api.loads.view', 'uses' => 'LoadsController@getDataView' ] );
        } );
        ...
        Route::group( [ 'prefix' => 'vehicles' ], function () {
            ...
            Route::get( 'list/{status?}', [ 'as' => 'api.vehicles.list', 'uses' => 'VehiclesController@getDatatable' ] );
            Route::get( '{vehicleId}/check', function ( $vehicleId ) {

                $vehicle = Vehicle::find( $vehicleId );

                return $vehicle->show_mac_address;
            } );

            Route::get( '{vehicleID}/view', [ 'as' => 'api.vehicles.view', 'uses' => 'VehiclesController@getDataView' ] );
        } );
        ...
        Route::group( [ 'prefix' => 'items' ], function () {
            ...
            Route::get( 'list', [ 'as' => 'api.items.list', 'uses' => 'ItemsController@getDatatable' ] );
        ...
        /*-- Drivers API (mostly for creating new ones in-line while creating an asset) --*/
        Route::group( [ 'prefix' => 'drivers' ], function () {

            Route::resource( '/', 'DriversController' );
        } );

        /*-- Customers API (mostly for creating new ones in-line while creating an asset) --*/
    ...
    */
    ...
    Route::group( [ 'prefix' => 'hardware', 'namespace' => 'Controllers\Admin', 'before' => 'admin-auth' ],
        function () {
            ...
            Route::group( [ 'prefix' => 'vehicles', 'before' => 'admin-auth' ], function () {

                Route::get( '/', [ 'as' => 'vehicles', 'uses' => 'VehiclesController@getIndex' ] );
                Route::get( 'create', [ 'as' => 'create/vehicle', 'uses' => 'VehiclesController@getCreate' ] );
                Route::post( 'create', 'VehiclesController@postCreate' );
                Route::get( '{vehicleId}/edit', [ 'as' => 'update/vehicle', 'uses' => 'VehiclesController@getEdit' ] );
                Route::post( '{vehicleId}/edit', 'VehiclesController@postEdit' );
                Route::get( '{vehicleId}/clone', [ 'as' => 'clone/vehicle', 'uses' => 'VehiclesController@getClone' ] );
                Route::post( '{vehicleId}/clone', 'VehiclesController@postCreate' );
                Route::get( '{vehicleId}/delete', [ 'as' => 'delete/vehicle', 'uses' => 'VehiclesController@getDelete' ] );
                Route::get( '{vehicleId}/view', [ 'as' => 'view/vehicle', 'uses' => 'VehiclesController@getView' ] );
                Route::get( '{vehicleID}/restore', [ 'as' => 'restore/vehicle', 'uses' => 'VehiclesController@getRestore' ] );
            } );
        } );
    ...
    */
    ...
    Route::group( [ 'prefix' => 'admin', 'before' => 'admin-auth', 'namespace' => 'Controllers\Admin' ], function () {
        ...
        Route::group( [ 'prefix' => 'loads' ], function () {
            ...
            Route::get( 'create', [ 'as' => 'create/load', 'uses' => 'LoadsController@getCreate' ] );
            Route::post( 'create', 'LoadsController@postCreate' );
            Route::get( '{loadID}/edit',
                [ 'as' => 'update/load', 'uses' => 'LoadsController@getEdit' ] );
            Route::post( '{loadID}/edit', 'LoadsController@postEdit' );
            Route::get( '{loadID}/delete',
                [ 'as' => 'delete/load', 'uses' => 'LoadsController@getDelete' ] );
            Route::get( '{loadID}/view',
                [ 'as' => 'view/load', 'uses' => 'LoadsController@getView' ] );
            Route::get( '{loadID}/checkout',
                [ 'as' => 'checkout/load', 'uses' => 'LoadsController@getCheckout' ] );
            Route::post( '{loadID}/checkout', 'LoadsController@postCheckout' );
            Route::get( '/', [ 'as' => 'accessories', 'uses' => 'LoadsController@getIndex' ] );
        } );
        ...
        Route::group( [ 'prefix' => 'settings', 'before' => 'admin-auth' ], function () {
            ...
            Route::group( [ 'prefix' => 'drivers' ], function () {
                ...
                Route::get( '/', [ 'as' => 'drivers', 'uses' => 'DriversController@getIndex' ] );
                Route::get( 'create', [ 'as' => 'create/driver', 'uses' => 'DriversController@getCreate' ] );
                Route::post( 'create', 'DriversController@postCreate' );
                Route::get( '{driverId}/edit',
                    [ 'as' => 'update/driver', 'uses' => 'DriversController@getEdit' ] );
                Route::post( '{driverId}/edit', 'DriversController@postEdit' );
                Route::get( '{driverId}/delete',
                    [ 'as' => 'delete/driver', 'uses' => 'DriversController@getDelete' ] );
                Route::get( '{driverId}/view', [ 'as' => 'view/driver', 'uses' => 'DriversController@getView' ] );
            } );
            ...
            Route::group( [ 'prefix' => 'customers' ], function () {
                ...
                Route::get( 'create', [ 'as' => 'create/customer', 'uses' => 'CustomersController@getCreate' ] );
                Route::post( 'create', 'CustomersController@postCreate' );
                Route::get( '{customerId}/edit',
                    [ 'as' => 'update/customer', 'uses' => 'CustomersController@getEdit' ] );
                Route::post( '{customerId}/edit', 'CustomersController@postEdit' );
                Route::get( '{customerId}/delete',
                    [ 'as' => 'delete/customer', 'uses' => 'CustomersController@getDelete' ] );
                Route::get( '{customerId}/view', [ 'as' => 'view/customer', 'uses' => 'CustomersController@getView' ] );
            } );
            # Categories
            Route::group( [ 'prefix' => 'categories' ], function () {
            ...
            Route::group( [ 'prefix' => 'items' ], function () {
                ...
                Route::get( 'create', [ 'as' => 'create/item', 'uses' => 'ItemsController@getCreate' ] );
                Route::post( 'create', 'ItemsController@postCreate' );
                Route::get( '{itemId}/edit',
                    [ 'as' => 'update/item', 'uses' => 'ItemsController@getEdit' ] );
                Route::post( '{itemId}/edit', 'ItemsController@postEdit' );
                Route::get( '{itemId}/delete',
                    [ 'as' => 'delete/item', 'uses' => 'ItemsController@getDelete' ] );
                Route::get( '{itemId}/view',
                    [ 'as' => 'view/item', 'uses' => 'ItemsController@getView' ] );
                Route::get( '/', [ 'as' => 'items', 'uses' => 'ItemsController@getIndex' ] );
            } );
            # Depreciations
